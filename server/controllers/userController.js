...
export async function getUserProfile(req, res){
  try {
    ...
    const findUser = await sql`
      SELECT userid, first_name, last_name, email, phone, birthday, department, program, username, isadmin, bvc_programs.programname
      FROM bvc_users
      LEFT JOIN bvc_programs ON bvc_users.program = bvc_programs.programcode
